...
lineaccesstoken = '1smOFib8FOzRHy1Y/StStFGncEo06Z9Y5abT/Uxny5aVTt6lkCN6NmQkpjZmXqx1s/E4DGx1PxeeutOtuTU0HtJK/Ho0RjSIsbQPdYCBPkis4fDMmSURF8rMfcef0VGs3W8PA5VBpAWp2DdTdVBX3AdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            replyObj = TextSendMessage(text="เออ...ดีจ้า")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "กินข้าวไหม" :
            replyObj = TextSendMessage(text="กินๆหิวมากเลย")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ฝันดีนะ" :
             replyObj = TextSendMessage(text="ฝันดีเช่นกัน")
             line_bot_api.reply_message(rtoken, replyObj)
        else :
           headers = request.headers
           json_headers = ({k:v for k, v in headers.items()})
           json_headers.update({'Host':'bots.dialogflow.com'})
           url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/e626bb27-1719-48a8-a950-488c75f9dcaf"
